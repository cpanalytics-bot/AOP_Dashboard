...
export function defaultAop(userId: string): Aop {
  ...
  return {
    ...
    universe: {
      ...
      nonUserSchools: NaN,
      categories: [
        { category: "A", currentCount: 30, activeCount: 26, sampledCount: 18, userCount: 12, targetCount: NaN, samplingCount: NaN, conversionCount: NaN, projectedRevenue: NaN, projectedConversion: NaN },
        { category: "B", currentCount: 28, activeCount: 22, sampledCount: 14, userCount: 9, targetCount: NaN, samplingCount: NaN, conversionCount: NaN, projectedRevenue: NaN, projectedConversion: NaN },
        { category: "C", currentCount: 22, activeCount: 15, sampledCount: 8, userCount: 5, targetCount: NaN, samplingCount: NaN, conversionCount: NaN, projectedRevenue: NaN, projectedConversion: NaN },
        { category: "D", currentCount: 0, activeCount: 0, sampledCount: 0, userCount: 0, targetCount: NaN, samplingCount: NaN, conversionCount: NaN, projectedRevenue: NaN, projectedConversion: NaN },
        { category: "Unknown", currentCount: 0, activeCount: 0, sampledCount: 0, userCount: 0, targetCount: NaN, samplingCount: NaN, conversionCount: NaN, projectedRevenue: NaN, projectedConversion: NaN },
        { category: "Chain", currentCount: 0, activeCount: 0, sampledCount: 0, userCount: 0, targetCount: NaN, samplingCount: NaN, conversionCount: NaN, projectedRevenue: NaN, projectedConversion: NaN },
      ],
...
export function seededAops(): Record<string, Aop> {
  ...
  a.universe.categories = a.universe.categories.map((c) => ({
    ...
    samplingCount: Math.round((c.currentCount + 4) * 0.6),
    conversionCount: Math.round((c.currentCount + 4) * 0.25),
