...
export function defaultAop(userId: string): Aop {
  ...
  return {
    ...
    universe: {
      ...
      nonUserSchools: 242,
      categories: [
        { category: "Chain Schools", currentCount: 12, targetCount: 12, projectedRevenue: 0, projectedConversion: 0 },
        { category: "Premium Schools", currentCount: 18, targetCount: 18, projectedRevenue: 0, projectedConversion: 0 },
        { category: "Category A", currentCount: 30, targetCount: 30, projectedRevenue: 0, projectedConversion: 0 },
        { category: "Category B", currentCount: 28, targetCount: 28, projectedRevenue: 0, projectedConversion: 0 },
        { category: "Category C", currentCount: 22, targetCount: 22, projectedRevenue: 0, projectedConversion: 0 },
      ],
