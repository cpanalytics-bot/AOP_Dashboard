...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
        ...
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-4 py-3">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-2.5 py-1.5 text-[12px] text-gray-500 hover:bg-gray-100 lg:inline-flex"
            >
      ...
      <main className="mx-auto w-full max-w-6xl px-4 pb-[calc(6rem+env(safe-area-inset-bottom))] pt-5 sm:pb-10 sm:pt-6">{children}</main>
